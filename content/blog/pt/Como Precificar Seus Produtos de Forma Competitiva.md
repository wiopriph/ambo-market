...
Itens novos têm um valor diferente de itens usados. Mesmo entre produtos usados, o grau de desgaste faz diferença.
...
| Categoria          | Produto Novo (100%) | Semi-novo (%) | Usado (%) |
|--------------------|---------------------|--------------|-----------|
